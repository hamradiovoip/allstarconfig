...
public class EchoLinkConfigData {
	...
	public String buildEcholink()
	{
		...
		s.append(" [el0]\n" + 
				"call = " + this.call + "				; Change this!\n" + 				
				"pwd = "+ this.pwd +"				; Change this!\n" + 
				"name = "+ this.name +"			; Change this!\n" + 
				"qth = "+ this.qth +"				; Change this!\n" + 
				"email = "+ this.email +"				; Change this!\n" + 
				"node = "+ this.node +"                           ; Change this!\n");
		s.append("; Data for EchoLink Status Page\n" + 
				"lat = "+this.lat+"				; Latitude in decimal degrees\n" + 
				"lon = "+this.lon+"				; Longitude in decimal degrees\n" + 
				...
				"astnode = "+ this.astnode + "				; Change this!\n" + 
