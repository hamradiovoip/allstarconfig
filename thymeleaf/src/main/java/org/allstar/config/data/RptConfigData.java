...
public class RptConfigData {
	...
	public String rxchannel = "0"; //  need to convert to string with the channels, some need node #
	...
	public RptConfigData(String rxchannel, String nodeNumber, String call, String duplex)
	{
		...
		int chInt = Integer.parseInt(rxchannel);

		String rxChStr = convertChannelStr(chInt, nodeNumber);

		this.rxchannel = rxChStr;	
		this.call = call;
		this.duplex = duplex;
	 ...
	 * 
	 */
	public String convertChannelStr(int ch, String node)
	{

		String chStr = "";

		switch(ch) {
		case 0:  chStr = "dahdi/pseudo"; 	 
		break;

		case 1:  chStr = "SimpleUSB/usb_"+node; 	 
		break;

		case 2:  chStr = "Pi/1"; 	 
		break;

		case 3:  chStr = "Radio/usb_"+node; 	 
		break;

		case 4:  chStr = "Dahdi/1"; 	 
		break;

		case 5:  chStr = "Beagle/1"; 	 
		break;

		case 6:  chStr = "USRP/127.0.0.1:34001:32001"; 	 
		break;
    ...
    /* gets and sets TODO need to use lombok instead of these */
	...
	/*
	 * generate the string for the rpt.conf files 
	 */
	public String buildRptString()
	{
		...
		// *** rx channel
		s.append("rxchannel = "+ this.rxchannel +"\n\n"); 
